    ...
    <body style = margin:0px>
        ...
        <header>
            ...
            <div class = "grayBlock menu">
                <ul>
                    ...
                    <li class="grayLi"><a href="CS_Record.html">歷史紀錄</a></li>
                </ul>
                <ul class = "dropDown">
                    <li><a>Hi,
                            <span>出納人員</span>
        ...
        <div class = "centerRegion">
            <div class = "text">
                ...
                <!-- 確認鍵 -->
                <div>
                    <a href = "CS_Record.html"><button type="button" style="cursor: pointer; margin-top: 2em">確認</button></a>
                </div>
            </div>
        </div>
