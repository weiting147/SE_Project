    ...
    <body style = margin:0px>
        ...
        <div class = "centerRegion">
            <div class = "text">
                ...
                <div class = "bottom" style = "text-align: center;">
                    <a href = "CS_Unpaid.html"><button type="button" style="cursor: pointer; margin: 4em 2em 0 0;">取消修改</button></a>
                    <a href = "CS_PasswdChecking.html"><button type="button" style="cursor: pointer; margin: 4em 0 0 2em;">確認修改</button></a>
                </div>
            </div>
        </div>
        ...
        <footer style = "margin: 0%;">
            ...
            <div class="grayBlock" style = "padding-left:3%;padding-top: 1.5%; padding-bottom:1.5%; color: #ffffff;line-height: 1.3em;">
                ...
                © 2019 高雄大學 National University of Kaohsiung<br><br>
