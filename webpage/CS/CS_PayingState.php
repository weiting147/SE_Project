    ...
    <body style = margin:0px>
        ...
        <header>
            ...
            <div class = "grayBlock menu">
                <ul>
                    <li class = "grayLi"><a href="CS_Unpaid.html">未繳費列表</a></li>
                    <li><a href="CS_Unrefund.html">需退費列表</a></li>
        ...
        <div class = "centerRegion">
            <div class = "text">
                ...
                <!-- 確認鍵 -->
                <div>
                    <a href = "CS_PayingStateChecking.html"><button type="button" style="cursor: pointer; margin:2em 2em 0 0;">已繳費</button></a>
                    <a href = "CS_Unpaid.html"><button type="button" style="cursor: pointer; margin: 2em 0 0 2em">取消</button></a>
                </div>
            </div>
        </div>
