    ...
    <body style = margin:0px>
        ...
        <header>
            ...
            <div class = "grayBlock menu">
                <ul>
                    <li><a href="CS_Unpaid.html">未繳費列表</a></li>
                    <li class = "grayLi"><a href="CS_Unrefund.html">需退費列表</a></li>
                    <li><a href="CS_Record.html">歷史紀錄</a></li>
                </ul>
                <ul class = "dropDown">
                    <li><a>Hi,
                            <span>出納人員</span>
                        ...
                        <ul>
                            <li><a href="CS_ModifyPasswd.html">密碼修改</a></li>
            ...
            <div class = "text">
                <div style="border: 2px #707070 solid; margin: 0px 100px; padding-top: 20px" >
                    ...
                    <div style = "display: flex; align-items: center; margin: 25px 150px;">
                        ...
                        <span style="width: 1.8em;"></span> <!--排版用的-->
                        <div>
                    ...
                    <div class="content" style="align-items: flex-end">
                        ...
                        <div style="width: 25em;">　<!--右區域：露營區部分-->
                            <div class = "stateflex" style="margin: 10px 0px;">
                ...
                <!-- 確認鍵 -->
                <div>
                    <a href = "CS_RefundStateChecking.html"><button type="button" style="cursor: pointer; margin:2em 2em 0 0;">已退費</button></a>
                    <a href = "CS_Unrefund.html"><button type="button" style="cursor: pointer; margin: 2em 0 0 2em">取消</button></a>
                </div>
            </div>
        </div>
