    ...
    <body style = margin:0px>
        ...
        <header>
            ...
            <div class = "grayBlock menu">
                        <ul>
                            ...
                            <li class="grayLi"ㄈ><a href="PAS_AnnouncementManage.html">公告</a></li>
                        </ul>
                <!-- 下拉式選單 -->
                <ul class = "dropDown">
                    <li class><a href="#">Hi,
        ...
        <div class = "centerRegion">
            <div class = "text">
                ...
                <!-- 確認鍵 -->
                <div>
                    <a href = "PAS_AnnouncementManage.html"><button type="button" style="cursor: pointer; margin-top: 2em;">確認</button></a>
                </div>
            </div>
        </div>
