    ...
    <body style = margin:0px>
        ...
        <header>
            ...
            <div class = "grayBlock menu">
                <ul>
                    ...
                    <li><a href=" href= PAS_Record.html">租借紀錄</a></li>
        ...
        <div class = "centerRegion">
            ...
            <div class = "right" style = "margin: 1em 0em">
                <input type="button" value="發布新公告" onclick="location.href='PAS_CreateAnnoucement.html'" style="cursor: pointer;">
            </div>
            <!-- 列表內容 -->
