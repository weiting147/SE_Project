...
<body style=margin:0px>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <!-- 確認鍵 -->
            <div>
                <a href="PAS_ApproveApplyReply.html"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">批准</button></a>
                <a href="PAS_Reject.html"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">不通過</button></a>
                <a href="PAS_FormManage.html"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">取消</button></a>
            </div>
        </div>
    </div>
