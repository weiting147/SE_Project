...
<body style=margin:0px>
    ...
    <header>
        ...
        <div class="grayBlock menu">
            <ul>
                <li class="grayLi"><a href="PAS_FormManage.php">申請批准</a></li>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <!-- 確認鍵 -->
            <div>
                <a href="PAS_ApproveApplyReply.php"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">批准</button></a>
                <a href="PAS_Reject.php"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">不通過</button></a>
                <a href="PAS_FormManage.php"><button type="button" style="cursor: pointer; margin:2em 0 0 2em;">取消</button></a>
            </div>
        </div>
    </div>
