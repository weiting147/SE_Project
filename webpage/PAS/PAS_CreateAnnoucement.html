        ...
        <div class = "centerRegion">
            <div class = "text">
                ...
                <div style="margin:2em 0em">
                    <input type="button" value="取消" onclick="location.href='PAS_AnnouncementManage.html'"style="margin: 0em 2em;cursor: pointer;">
                    <input type="button" value="確認新增" onclick="location.href='PAS_CreateAnnouncementCheck.html'"style="margin: 0em 2em; cursor: pointer;">
                </div>
