...
<html>
    ...
    <body style = margin:0px>
        ...
        <div class = "centerRegion">
            ...
            <div>
                <input type="button" value="取消" onclick="location.href='PAS_AccountManage.php'"style="margin: 0em 2em;cursor: pointer;">
                <input type="button" value="確認發布" onclick="location.href='PAS_CreateAnnouncementReply.php'"style="margin: 0em 2em; cursor: pointer;">
            </div>
            </div>
        </div>
