...
$title = $_POST["title"];
$time = $_POST["time"];
$text = $_POST["author_text"];
$announceQuery = <<<EOF
    Select Count(*) From Announcement Where identity = 1;    
EOF;
$currentNum = sendQuery($announceQuery);
$currentNum = mysqli_fetch_row($currentNum)[0];
$currentNum += 1;
$announceQuery = <<<EOF
    Insert Into Announcement values (1, 'place$currentNum', '$time', '$title', '$text');    
EOF;

$ret = sendQuery($announceQuery);
?>
<html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>PAS_CreateAnnouncementReply</title>
</head>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <div>
                ...
                <input type="button" value="確認" onclick="location.href='PAS_AnnouncementManage.php'" style="margin: 0em 2em; cursor: pointer;">
            </div>
