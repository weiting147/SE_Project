    ...
    <div class="centerRegion">
        <div class="text">
            ...
            <div class="bottom" style="text-align: center;">
                <a href="RS_AccountInfo.html"><button type="button" style="cursor: pointer; margin-right: 2em;">取消修改</button></a>
                <a href="RS_AccountModifyCheck.html"><button type="button" style="cursor: pointer; margin-left: 2em;">確認修改</button></a>
            </div>
        </div>
    </div>
