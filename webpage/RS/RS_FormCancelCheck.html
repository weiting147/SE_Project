...
<head>
    ...
    <meta charset="utf-8">
    <title> RS_FormCancelCheck</title>
</head>
    ...
    <div class="centerRegion">
        <div class="text">
            ...
            <div class="bottom" style="text-align: center;">
                <a href="RS_RecordInfo.html"><button type="button" style="cursor: pointer; margin-right:2em;">取消</button></a>
                <a href="RS_FormCancelCheckReply.html"><button type="button" style="cursor: pointer; margin-left:2em;">確認</button></a>
            </div>
        </div>
    </div>
