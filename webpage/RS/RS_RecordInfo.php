...
=======
>>>>>>> 47408e391dc149c1873c0b3ed4720d86f118aea4
...
<body style=margin:0px>
    ...
    <div class="centerRegion">
        ...
        <div style="background-color: #707070; width: 100%; height: 7px; margin-top: -1em;"></div>
        <div class="text">
            ...
            <!-- 確認鍵 -->
            <div>
                <a href="RS_Record.html"><button type="button" style="cursor: pointer; margin:2em 2em 0 0;">確認</button></a>
                <a href="RS_FormModify.html"><button type="button" style="cursor: pointer; margin-top: 2em;">修改訂單</button></a>
                <a href="RS_FormCancelCheck.html"><button type="button" style="cursor: pointer; margin: 2em 0 0 2em">取消訂單</button></a>
            </div>
        </div>
    </div>
