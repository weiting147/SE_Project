...
<head>
    ...
    <meta charset="utf-8">
    <title>SAS_AccountDeleteCheck</title>
</head>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            <p class="reply" style="padding: 2em 0;">
                <span>是否刪除已選取帳號資料？</span>
            </p>
            <div>
                <input type="button" value="取消" onclick="location.href='SAS_AccountManage.html'" style="cursor: pointer; margin:0em 2em">
                <input type="button" value="確認" onclick="location.href='SAS_AccountDeleteReply.html'" style="cursor: pointer; margin:0em 2em">
            </div>
        </div>
    </div>
