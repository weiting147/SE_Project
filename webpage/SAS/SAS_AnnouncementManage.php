...
<head>
    ...
    <meta charset="utf-8">
    <title>SAS_AnnouncementManage</title>
</head>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <div class="right" style="margin: 1em 0em">
                <input type="button" value="發布新公告" onclick="location.href='SAS_CreateAnnoucement.html'" style="cursor: pointer;">
            </div>
            <!-- 列表內容 -->
