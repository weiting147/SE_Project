...
<body style=margin:0px>
    ...
    <div class="centerRegion">
        <div class="text">
            ...
            <div class="content" style="margin: 1em 35%">
                <p> 帳號開頭：</p>
                <input type="text" style="width: 18em;" placeholder="如：A10755" />
            </div>
            <div class="content" style="margin: 1em 35%">
                <p> 帳號數量：</p>
                <input type="text" style="width: 18em;" />
            </div>
            <div class="content" style="margin: 1em 35%" ; text-align: left;>
                <span> 身分別為：</span> &nbsp;&nbsp;
                <!--空格-->
                <input type="radio" id="r1" name="rr" />
                <label for="r1">學生</label> &nbsp;&nbsp;
                <input type="radio" id="r2" name="rr" />
                <label for="r2">教職員</label> &nbsp;&nbsp;
                <input type="radio" id="r2" name="rr" />
                <label for="r3">校外人士</label>
            </div>
            <div class="content" style="margin: 1em 34%">
                <p style="font-size: 0.8em; width: auto;" ;>
                    備註：<br> 1. 新帳號的密碼預設與帳號相同。<br> 2. 若欲更改帳號的詳細資訊，請至"帳號詳細資料頁面"進行修改。
                </p>
            </div>
            <!-- 確認鍵 -->
            <div>
                <a href="SAS_AccountManage.html" style="margin:0em 1em;"><button type="button" style="cursor: pointer;">取消</button></a>
                <a href="SAS_CreateAccountCheck.html" style="margin:0em 1em;"><button type="button" style="cursor: pointer;">確認</button></a>
            </div>
        </div>
    </div>
