...
<head>
    ...
    <meta charset="utf-8">
    <title>SAS_CreateAccountReply</title>
</head>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <div>
                ...
                <!-- <input type="button" value="確認" onclick="location.href='SAS_AccountManage.html'"style="margin: 0em 1em; cursor: pointer;"> -->
                <meta http-equiv="refresh" content="4;url=SAS_AccountManage.html">
            </div>
