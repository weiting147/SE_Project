...
<head>
    ...
    <meta charset="utf-8">
    <title>SAS_CreateAnnouncementCheck</title>
</head>
...
<body style=margin:0px>
    ...
    <div class="centerRegion">
        ...
        <div class="text">
            ...
            <div>
                <input type="button" value="取消" onclick="location.href='SAS_AccountManage.html'" style="margin: 0em 2em;cursor: pointer;">
                <input type="button" value="確認發布" onclick="location.href='SAS_CreateAnnouncementReply.html'" style="margin: 0em 2em; cursor: pointer;">
            </div>
        </div>
    </div>
