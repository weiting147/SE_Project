...
<body style=margin:0px>
    ...
    <header>
        ...
        <div style="padding-left: 3%;" display: inline-block>
            ...
            <a href="#" class="logoTEXT">烤肉露營區管理系統</a>
        </div>
    ...
    <div class="centerRegion">
        <div class="text">
            ...
            <div class="content">
                ...
                <div class="formBlock">
                    <!-- <input type = "text" name = "pswCheck" style="width: 200px" readonly="readonly"> -->
                </div>
            </div>
            <div class="content">
                <div class="formTextR">
        ...
        <div class="bottom" style="text-align: center;">
            <a href="SAS_AccountManage.html"><button type="button" style="cursor: pointer; margin-right: 2em;">確認</button></a>
            <a href="SAS_AccountModify.html"><button type="button" style="cursor: pointer; margin-left: 2em;">修改</button></a>
        </div>
    </div>
    </div>
